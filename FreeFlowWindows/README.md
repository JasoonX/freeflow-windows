<p align="center">
  <img src="Resources/AppLogo.png" width="128" height="128" alt="FreeFlow for Windows icon">
</p>
...
speak, release, and FreeFlow inserts the transcript into the focused text field.

This alpha is Groq-only and unsigned. Windows may show a SmartScreen warning on
first launch.

## Quick Start

1. Download `FreeFlow-for-Windows-win-x64.zip`.
